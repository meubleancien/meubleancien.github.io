...
* Technical: FHE works today, but is still a bit limited, in term of model size and variety, but also regarding types you can encrypt (only small integer). For certain features it means finding a way to make them simpler in order to be encrypted.
